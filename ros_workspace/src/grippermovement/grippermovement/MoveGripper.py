...
class MoveGripper(Node):
    ...
    def __init__(self):
        ...
        self.timer = self.create_timer(0.01, self.movegripper())
    ...
    def init_zone_values(self):
        """
        initialize the destiny position arrays once
        """
    ...
    def initialize(self):
        """
        this function initialize the destiny position arrays once
        """
